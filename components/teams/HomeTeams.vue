<template>
  <section :class="`team__area ${style_2?'pt-110 pb-110':'pt-115'}`">
    <div class="container">
      ...
      <div class="row">
        <div class="col-xxl-12" style="margin-bottom: 40px">
          <div
          ...
          >
            ...
            >
              <swiper-slide v-for="(item, i) in facultyData" :key="i">
...
// internal
import facultyData from "~/mixins/facultyData";
import SingleTeam from "./single-team/SingleTeam.vue";
import SalScrollAnimationMixin from "~/mixins/SalScrollAnimationMixin";

export default {
  mixins: [facultyData,SalScrollAnimationMixin],
  props:{
    style_2:{
      type:Boolean,
      default:false
