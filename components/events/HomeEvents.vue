    ...
    <div class="container">
        ...
        <div class="col-xxl-9 col-xl-8">
          <div class="section__title-wrapper mb-50">
            <h3 class="section__title">
              {{$t('environment.title_1')}}
              <span class="section__title-highlight"
                >{{$t('environment.title_2')}}
      ...
      <div class="row">
        <div class="col-xxl-12">
          <SingleEvent v-for="(item, index) in items" :key="index"
            :index="index+1"
            :title="item.title"
            :date="item.desc"
          />
...
export default {
  ...
  computed: {
    items() {
      return [
        {title: this.$t('environment.label_1'), desc: this.$t('environment.desc_1')},
        {title: this.$t('environment.label_2'), desc: this.$t('environment.desc_2')},
        {title: this.$t('environment.label_3'), desc: this.$t('environment.desc_3')},
        {title: this.$t('environment.label_4'), desc: this.$t('environment.desc_4')},
        {title: this.$t('environment.label_5'), desc: this.$t('environment.desc_5')},
        {title: this.$t('environment.label_6'), desc: this.$t('environment.desc_6')},
        {title: this.$t('environment.label_7'), desc: this.$t('environment.desc_7')},
        {title: this.$t('environment.label_8'), desc: this.$t('environment.desc_8')},
        {title: this.$t('environment.label_9'), desc: this.$t('environment.desc_9')}
      ]
    }
  }
};
