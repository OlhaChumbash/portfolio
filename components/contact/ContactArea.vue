<template>
  <contact-top-area title="" :subtitle="$t('contacts.title')"/>
  <!-- contact item start -->
...
<!--                    <p><a href="tel:380674317424">+(602) 762 472 96</a></p>-->
<!--                </div>-->
<!--              </div>-->
          </div>
          <div class="col-xl-4 col-lg-4 col-md-6">
            <div class="contact__item text-center mb-30 transition-3 white-bg">
              ...
              <div class="contact__content">
                  <span class="contact-item-subtitle">Contact</span>
                  <p>intita.hr@gmail.com</p>
                  <p>+38 067 431 74 24</p>
              </div>
            </div>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-6">
...
<!--  &lt;!&ndash; contact location area start &ndash;&gt;-->
