        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          <div class="about__thumb-wrapper ml-70 pr-100">
            ...
            <div class="about__thumb-text">
              <h3 :data-text="$t('university.mission')">{{$t('university.mission')}}</h3>
            </div>
            <div class="about__experience">
              <p>
                {{$t('university.free')}} <br /> {{$t('university.individuals')}}
              </p>
            </div>
          </div>
        </div>
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          ...
          >
            <div class="section__title-wrapper mb-25">
              <span class="section__title-pre">{{$t('university.university')}}</span>
              <h3 class="section__title">
                {{$i18n.locale === 'uk' ? 'Місія' : 'Mission of the'}}
                <span class="section__title-highlight">
                    {{$i18n.locale === 'uk' ? 'Університету' : 'University'}}
