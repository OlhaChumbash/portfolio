        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          <div class="about__thumb-wrapper-4 p-relative">
            <div class="about__thumb-4">
              <img class="about-thumb-main" src="~/assets/img/licey/staguvannya.png" alt="">
              <img class="about__thumb-shape-1" src="~/assets/img/about/4/about-shape-1.png" alt="">
            </div>
            <div class="about__experience-4 d-none d-sm-flex align-items-start blue-dark-color-bg">
              
              <div class="white-color ">
                <h4 class="white-color ">Стажування в <br> ІТ компаніях</h4>
                <p  class="white-color "> Реальні проекти</p>
              </div>
            </div>
            <div class="about__thumb-shape-2 p-relative">
              <img class="about__thumb-shape-logod" src="~/assets/img/licey/about-sign.png" alt="">
              <img class="about__thumb-shape-logo-icon m-icon" src="~/assets/img/licey/Icon.png" alt="">
            </div>
          </div>
        </div>
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          <div class="about__wrapper-4 pr-70">
            <div class="section__title-wrapper-4 pr-5 mb-15">
              <span class="section__title-pre-4 "><span class="blue-color">Навчання</span></span>
              <h3 class="section__title-4-2">Про ліцей</h3>
            </div>
            <p>Ліцей ІНТІТА – це унікальне поєднання середньої освіти та професійної ІТ-підготовки. 
              Ми готуємо майбутніх фахівців, які не лише отримують свідоцтво а й опановують актуальні технології.</p>
            <div class="about__btn-4 mt-45 d-sm-flex align-items-center">
             <span v-html="'&nbsp;&nbsp;&nbsp;&nbsp;'"></span>
              <!-- <nuxt-link href="#" class="mr-30 tp-btn white-color blue-clolor-bg font-banner">Дізнатися більше</nuxt-link> -->
              <div class="about__call d-flex align-items-center">
                ...
                <div class="about__call-content">                  
                  <p><a class="gray-color" href="tel:380674317424">+38 063 189 22 56</a></p>
                </div>
              </div>
            </div>
          </div>
