...
<!--                    <p>The home and elements needed to create beautiful products.</p>-->
                    <div class="footer__contact">
                      <div class="footer__contact-call">
                        <span>
                          <a href="tel:3806 4317424">
                            <i class="fa-solid fa-phone"></i>
                            <span class="ml-10">+38 067 431 74 24</span>
                          </a>
                        </span>
                      </div>
                      <div class="footer__contact-mail">
                        <span><a href="mailto:intita.hr@gmail.com">intita.hr@gmail.com</a></span>
                      </div>
                    </div>
...
<!--                      <social/>-->
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div class="footer__widget mb-50 footer-col-2">
                <h3 class="footer__widget-title"><nuxt-link href="#university">{{$t('menu.university')}}</nuxt-link></h3>
<!--                <div class="footer__widget-content">-->
<!--                  <ul>-->
...
<!--                </div>-->
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div class="footer__widget mb-50 footer-col-3">
                <h3 class="footer__widget-title"><nuxt-link href="#faculties">{{$t('menu.faculties')}}</nuxt-link></h3>
<!--                <div class="footer__widget-content">-->
<!--                  <ul>-->
...
<!--                </div>-->
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div class="footer__widget mb-50 footer-col-3">
                <h3 class="footer__widget-title"><nuxt-link href="#contacts">{{$t('menu.contacts')}}</nuxt-link></h3>
                <!--                <div class="footer__widget-content">-->
                <!--                  <ul>-->
                <!--                    <li><nuxt-link href="/job">Careers</nuxt-link></li>-->
                <!--                    <li><nuxt-link href="/job">Job Post</nuxt-link></li>-->
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="footer__copyright">
                  <p><nuxt-link href="/">© {{new Date().getFullYear()}} INTITA</nuxt-link>
                    All Rights Reserved.
                  </p>
                </div>
              </div>
