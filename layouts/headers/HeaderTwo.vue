        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-4 col-6">
              <div class="logo">
                <NuxtLink to="/">
                  <img src="~/assets/img/logo/logo-black.svg" alt="INTITA IT-Ліцей">
                </NuxtLink>
              </div>
            </div>
            <div class="col-xxl-5 col-xl-5 col-lg-3 d-none d-lg-block">
              <div class="header__welcome">
                <p class="d-none d-xl-inline-block">Приймаємо учнів 8–11 класів</p>
                <p> Свідоцтво державного зразка</p>
              </div>
            </div>
              ...
              <div class="header__top-right-4 d-flex align-items-center justify-content-end">
                <div class="header__info-wrapper-4 d-flex align-items-center justify-content-end">
                      ...
                      <span>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            ...
                            stroke="#5C94C5" stroke-width="1.5" stroke-miterlimit="10" />
                          <path
                            d="M12.5497 5.89986C12.5497 5.47986 12.2207 4.83586 11.7307 4.31086C11.2827 3.82786 10.6877 3.44986 10.0997 3.44986"
                            stroke="#5C94C5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M14.9997 5.9C14.9997 3.191 12.8087 1 10.0997 1" stroke="#5C94C5"
                  ...
                  <div class="header__info-item d-none d-lg-flex align-items-center">
                      ...
                      <span>
                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            ...
                            stroke="#5C94C5" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                    ...
                    <div class="header__info-content">
                      <h4>Email:</h4>
                      <p><a class="gray-color" href="mailto:intita.hr@gmail.com">intita.hr@gmail.com</a></p>
                    </div>
                  </div>
                </div>
